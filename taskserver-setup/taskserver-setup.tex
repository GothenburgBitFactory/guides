...
$ sudo yum install cmake\end{lstlisting}
...
$ sudo apt install cmake\end{lstlisting}
...
$ sudo dnf install cmake\end{lstlisting}
...
$ sudo zypper install cmake\end{lstlisting}
