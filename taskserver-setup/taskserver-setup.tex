...
<p>
  Let's reinforce a good habit and make a backup copy of your data
...
<p>
  Now move that file somewhere safe.  All software contains bugs, so
  make regular backups.
</p>

<a name="machine"></a>
<h4>Choose a Machine</h4>
<p>
  A suitable machine to run your Taskserver is one that is always
  available. If you have such a machine, or have access to a hosted
  machine, that is ideal.
</p>
